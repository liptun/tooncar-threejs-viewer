...
export function SpeedIndicator({ speed, visible }: Props) {
  return (
    <div className={`pointer-events-none absolute bottom-3 left-3 z-20 w-44 bg-[#10162d]/45 px-3 py-2 shadow-[0_8px_24px_rgba(0,0,0,.12)] backdrop-blur-sm transition-opacity duration-300 ${visible === true ? 'opacity-100' : 'opacity-0'}`} aria-hidden={visible === false}>
