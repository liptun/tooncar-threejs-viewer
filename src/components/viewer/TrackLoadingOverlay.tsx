    ...
    return (
      <div
        className={cn(
          ...
          "bg-[#0c1015] text-sm text-red-300",
        )}
      >
        {error}
      </div>
  ...
  return (
    <div
      className={cn(
        ...
        skyboxReady === true ? "bg-transparent" : "bg-[#0c1015]",
      )}
    >
      <div className="w-64 text-center">
        <div
          className={cn(
            ...
            "border border-[#f3ad00]/35 bg-[#f3ad00]/10 text-[#ffd455]",
          )}
        >
        ...
        <div className="mt-4 h-1 overflow-hidden rounded-full bg-white/8">
          <div
            className="h-full rounded-full bg-[#f3ad00] transition-[width] duration-300"
